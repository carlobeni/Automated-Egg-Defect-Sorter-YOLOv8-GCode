...
class VitionManager:
    def __init__(self, model_path: str, workspace_limits: tuple, camera_id: int = 1):
        ...
        self.id_coord_map = {0: [2.7, -14.75], 1: [29.95, -14.75], 2: [29.95, 22.05], 3: [2.7, 22.05]}

        #self.id_coord_map = { 0: [0, 0], 1: [24.5, 0], 2: [24.5, 24.5], 3: [0, 24.5]}
        self.TABLERO_ALTO_CM = 22.05+14.75
    ...
    def is_egg_in_some_target(self) -> bool:
        return self._egg_detected and len(self._current_ids) > 0
